...
public class Test_00030001_AddOneTab extends InstrumentationTestCase {
	...
	public void test_AddOneTab() throws Exception {
		...
		UiObject2 browserTabManager = mDevice.findObject(By.clazz("android.widget.TextView").res("com.android.browser:id/action_tabs"));
...
//        browserTabManager.click();
        mDevice.findObject(By.clazz("android.widget.ImageButton").res("com.android.browser:id/action_new_tab")).click();
        mm.waitFor(5);
