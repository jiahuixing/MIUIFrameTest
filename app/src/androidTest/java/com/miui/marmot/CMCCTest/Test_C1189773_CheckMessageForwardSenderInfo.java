...
public class Test_C1189773_CheckMessageForwardSenderInfo extends InstrumentationTestCase{
	public Marmot mm;
    public Checker cc;
    ...
    public void test_C1189773_CheckMessageForwardSenderInfo() throws Exception {
    	mm.log("打开设置");
    	mm.pressHome();
