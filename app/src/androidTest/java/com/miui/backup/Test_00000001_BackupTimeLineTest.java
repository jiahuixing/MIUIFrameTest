...
public class Test_00000001_BackupTimeLineTest extends InstrumentationTestCase {
    ...
    public void test_00000001_BackupTimeLineTest() throws Exception {
        int testStep = 0;
        testStep += 1;
        ...
        UiObject2 autoBackup, autoBackupSwitch, autoBackupChoose, autoBackupAppsChoose, confirm;
        ...
        backupContacts = marmot.getUiObject(By.clazz("android.widget.TextView")
                .text("帐号和通讯录"));
        checkBoxApps = backupApps
                .getParent()
                .getParent()
                .findObject(
                        By.clazz("android.widget.CheckBox").res(
                                "com.miui.backup:id/data_item_cb"));
        checkBoxContacts = backupContacts
                .getParent()
                .getParent()
                .findObject(
                        By.clazz("android.widget.CheckBox").res(
