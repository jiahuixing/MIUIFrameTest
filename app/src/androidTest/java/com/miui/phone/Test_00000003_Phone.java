...
public class Test_00000003_Phone extends InstrumentationTestCase {
	...
	public void test_00000003_Phone() throws Exception {
		for (int i = 0; i < 20; i++) {
			...
			checker.assertTrue("contacts", marmot.getCurrentPackageName()
					.equals(PACKAGE_NAME_CONTACTS));
			...
			UiObject2 callSim1;
			callSim1 = marmot.getUiObject(By.clazz("android.widget.Button")
					.res("com.android.contacts:id/call_sim1"));
			// UiObject2 callSim2;
			// callSim2 =
			...
			checker.assertTrue("incallui", marmot.getCurrentPackageName()
					.equals(PACKAGE_NAME_IN_CALL_UI));
			marmot.waitFor(5);
			...
			hangOff.click();
			marmot.waitFor(2);
			checker.setTestrailResult("C513238", true);
		}
	}
