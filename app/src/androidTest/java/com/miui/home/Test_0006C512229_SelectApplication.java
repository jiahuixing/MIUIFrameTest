...
public class Test_0006C512229_SelectApplication extends InstrumentationTestCase {
    public Marmot mm;
    public Checker cc;
    ...
    public void test_00000000_SelectApplication() throws Exception {
        ...
        mm.log("Step 4: Select Application");
        mm.pressMenu();
        mm.click(By.text("桌面整理"));
        mm.click(By.text("相机"));
        mm.waitFor(1);
        mm.saveScreenshot("photo.png");
        mm.waitFor(1);
        mm.pressBack();
