...
public class Test_0013C521245_DeleteApplications extends InstrumentationTestCase {
    public Marmot mm;
    public Checker cc;
    ...
    public void test_00000000_DeleteApplications() throws Exception {
        int DisplayWidth;
        ...
        mm.log("Step 5:Slide the blank screen");
        mm.waitFor(1);
        mm.click(By.text("飞行模式"));
        mm.click(By.text("蓝牙"));
        mm.click(By.text("勿扰模式"));
        ...
        if (DisplayWidth == 1080) {
            mm.drag(400, 1700, 500, 100, 8); // delete
            mm.waitFor(3);
        }
        if (DisplayWidth == 1440) {
            mm.drag(500, 2300, 700, 70, 8);
            mm.waitFor(3);
        }
