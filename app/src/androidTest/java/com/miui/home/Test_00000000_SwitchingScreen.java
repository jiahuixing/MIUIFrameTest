...
public class Test_00000000_SwitchingScreen extends InstrumentationTestCase {
    public Marmot mm;
    public Checker cc;
    ...
    public void test_00000000_SwitchingScreen() throws Exception {
        ...
        if (!mm.isScreenOn()) {
            ...
            /*if(DisplayWidth <=480){
                mm.drag(300, 700, 300, 200, 4);
			}
			if(DisplayWidth <=540){
				mm.drag(300, 900, 300, 200, 4);
			}
			if(DisplayWidth <=720){
				mm.drag(300, 1000, 300, 500, 4);
			}
			if(DisplayWidth <=1080){
				mm.drag(500, 1700, 500, 500, 4);
			}else{
        ...
        mm.log("Step 2: C512226 Launch Settings Activity.");
        mm.pressHome();
